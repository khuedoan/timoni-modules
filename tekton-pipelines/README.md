...
A [timoni.sh](http://timoni.sh) module for deploying tekton-pipelines to Kubernetes clusters.
...
```shell
timoni -n default apply tekton-pipelines oci://<container-registry-url>
```
...
```shell
timoni -n default delete tekton-pipelines
```
